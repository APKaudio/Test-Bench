...
Public Class Form1
    ...
    Sub DoChart_ch_1()
        ...
        Rigol_Time_division()
        For I = 0 To ((RigolSplitWaveData_CH1.Length) - 1)
            ScopeGraph_ch_1.Points.AddXY(
                Math.Round((I * CDbl(Rigol_Time_Base.Text)) * Rigol_Scope_Scale, 3),
                RigolSplitWaveData_CH1(I))
        Next
        Rigol_Graph_1.Series.Add(ScopeGraph_ch_1)
    End Sub
    Sub DoChart_ch_2()

        Rigol_Graph_2.Series.Clear()
        ScopeGraph_ch_2.Points.Clear()
        ...
        Rigol_Time_division()
        For I = 0 To ((RigolSplitWaveData_CH2.Length) - 1)
            ScopeGraph_ch_2.Points.AddXY(
                Math.Round((I * CDbl(Rigol_Time_Base.Text)) * Rigol_Scope_Scale, 3),
                RigolSplitWaveData_CH2(I))
        Next
        Rigol_Graph_2.Series.Add(ScopeGraph_ch_2)
    End Sub
    Sub DoChart_ch_3()
        Rigol_Graph_3.Series.Clear()
        ScopeGraph_ch_3.Points.Clear()
        ...
        Rigol_Time_division()
        For I = 0 To ((RigolSplitWaveData_CH3.Length) - 1)
            ScopeGraph_ch_3.Points.AddXY(
                Math.Round((I * CDbl(Rigol_Time_Base.Text)) * Rigol_Scope_Scale, 3),
                RigolSplitWaveData_CH3(I))
        Next
        Rigol_Graph_3.Series.Add(ScopeGraph_ch_3)
    End Sub
    Sub DoChart_ch_4()
        Rigol_Graph_4.Series.Clear()
        ScopeGraph_ch_4.Points.Clear()
        ...
        Rigol_Time_division()
        For I = 0 To ((RigolSplitWaveData_CH4.Length) - 1)
            ScopeGraph_ch_4.Points.AddXY(
                Math.Round((I * CDbl(Rigol_Time_Base.Text)) * Rigol_Scope_Scale, 3),
                RigolSplitWaveData_CH4(I))
        Next
        Rigol_Graph_4.Series.Add(ScopeGraph_ch_4)
    End Sub
