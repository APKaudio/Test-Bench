...
Public Class Form1
    ...
    Public DataCollectionTable_SCOPE_CH1 As New DataTable("SCOPE_CH1")
    Public DataCollectionTable_SCOPE_CH2 As New DataTable("SCOPE_CH2")
    Public DataCollectionTable_SCOPE_CH3 As New DataTable("SCOPE_CH3")
    Public DataCollectionTable_SCOPE_CH4 As New DataTable("SCOPE_CH4")
    ...
    Private Sub DataFetchScope1()
        ...
        DataCollectionTable_SCOPE_CH1.Columns.Add("Channel 1")

        For I = 0 To (RigolSplitWaveData_CH1.Length - 1)
            DataCollectionTable_SCOPE_CH1.Rows.Add(RigolSplitWaveData_CH1(I))
        Next I

        DataGridView1.DataSource = DataCollectionTable_SCOPE_CH1

    End Sub


    Private Sub DataFetchScope2()
        ...
        DataCollectionTable_SCOPE_CH2.Columns.Add("Channel 2")

        For I = 0 To (RigolSplitWaveData_CH2.Length - 1)
            DataCollectionTable_SCOPE_CH2.Rows.Add(RigolSplitWaveData_CH2(I))
        Next I

        DataGridView2.DataSource = DataCollectionTable_SCOPE_CH2

    End Sub

    Private Sub DataFetchScope3()
        ...
        DataCollectionTable_SCOPE_CH3.Columns.Add("Channel 3")

        For I = 0 To (RigolSplitWaveData_CH3.Length - 1)
            DataCollectionTable_SCOPE_CH3.Rows.Add(RigolSplitWaveData_CH3(I))
        Next I

        DataGridView3.DataSource = DataCollectionTable_SCOPE_CH3

    End Sub


    Private Sub DataFetchScope4()
        ...
        DataCollectionTable_SCOPE_CH4.Columns.Add("Channel 3")

        For I = 0 To (RigolSplitWaveData_CH4.Length - 1)
            DataCollectionTable_SCOPE_CH4.Rows.Add(RigolSplitWaveData_CH4(I))
        Next I

        DataGridView4.DataSource = DataCollectionTable_SCOPE_CH4
